...
export default function About() {
  return      <main className="container col-12 col-md-9 col-xl-8 py-md-3 pl-md-5 bd-content" role="main">
  <h1 className="bd-title" id="content">About</h1>
  <p className="bd-lead">Learn more about the team maintaining Bootstrap, how and why the project started, and how to get involved.</p>
